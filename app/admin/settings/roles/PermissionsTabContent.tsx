...
export default function PermissionsTabContent({ permissionGroups }: PermissionsTabContentProps) {
  ...
  useEffect(() => {
    const flattenedPermissions: Permission[] = permissionGroups.flatMap((group: PermissionGroup) =>
      ...
      <Card className="rounded-lg border-none">
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <Button variant="outline" size="sm" onClick={() => router.push('/admin/settings/roles/permission-add')}>
